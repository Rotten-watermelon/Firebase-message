    ...
    try {
        (function() {
            ...
            function a(e, t) {
                ...
                return n.code = e, n.name = "FirebaseError", Object.setPrototypeOf(n, a.prototype), Error.captureStackTrace && Error.captureStackTrace(n, u.prototype.create), n
            }
            var u = (l.prototype.create = function(e) {
                for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n];
                for (var r, i = t[0] || {}, o = this.service + "/" + e, s = this.errors[e], a = s ? (r = i, s.replace(b, function(e, t) {
                        var n = r[t];
                        return null != n ? String(n) : "<" + t + "?>"
                    })) : "Error", u = this.serviceName + ": " + a + " (" + o + ").", c = new d(o, u), l = 0, f = Object.keys(i); l < f.length; l++) {
                    var p = f[l];
            ...
            var b = /\{\$([^}]+)}/g,
                f = (p.prototype.setInstantiationMode = function(e) {
            ...
            }, m(E, "_db", ["name", "version", "objectStoreNames"]), S(E, "_db", IDBDatabase, ["close"]), ["openCursor", "openKeyCursor"].forEach(function(o) {
            ...
            function ye(e, l) {
                ...
                return v(this, void 0, void 0, function() {
                    ...
                    return g(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return t = f, n = l.fid, r = W(t) + "/" + n + "/authTokens:generate", i = $(f, l), (o = p.getImmediate({
                                    optional: !0
                                })) && i.append("x-firebase-client", o.getPlatformInfoString()), s = {
                                    installation: {
                                        sdkVersion: M
                                    }
                                }, a = {
                        ...
                        switch (e.label) {
                            case 0:
                                return [4, he(a.appConfig, function(e) {
                                    ...
                                    if (u || 2 !== (r = i).requestStatus || function(e) {
                                            var t = Date.now();
            ...
            function me(e) {
                return he(e, function(e) {
                    if (!ke(e)) throw L.create("not-registered");
                    var t, n = e.authToken;
                    return 1 === (t = n).requestStatus && t.requestTime + N < Date.now() ? h(h({}, e), {
                        authToken: {
                            requestStatus: 0
                        }
                    }) : e
            ...
            function Ie(a, u) {
                return v(this, void 0, void 0, function() {
                    ...
                    return g(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return t = a, n = u.fid, r = W(t) + "/" + n, i = $(a, u), o = {
                                    method: "DELETE",
                                    headers: i
                                }, [4, G(function() {
                                    return fetch(r, o)
            ...
            }(oe = lt).INTERNAL.registerComponent(new f("installations", function(e) {
                                        ...
                                        return g(this, function(e) {
                                            switch (e.label) {
                                                ...
                                                case 2:
                                                    ...
                                                    } else(3 === o.oldVersion || 4 === o.oldVersion) && (s = {
                                                        token: (r = n).fcmToken,
            ...
            var it = (Object.defineProperty(ot.prototype, "app", {
                        ...
                        switch (e.label) {
                            ...
                            case 1:
                                return (n = e.sent()).some(function(e) {
                                    ...
                                    var n, r, i = at(Ye.PUSH_RECEIVED, t);
                                    try {
                                    ...
                                    if (e && "object" == typeof e.notification) {
                                        ...
                                        return n.data = h(h({}, e.notification.data), ((t = {})[He] = e, t)), n
                                    }
                                }(t)) ? [4, function(e) {
                ...
                return v(this, void 0, void 0, function() {
                    ...
                    return g(this, function(e) {
                        switch (e.label) {
                            case 0:
                                return !(n = null === (u = null === (a = s.notification) || void 0 === a ? void 0 : a.data) || void 0 === u ? void 0 : u[He]) || s.action ? [2] : (s.stopImmediatePropagation(), s.notification.close(), (r = function(e) {
                                    var t, n, r, i = null !== (n = null === (t = e.fcmOptions) || void 0 === t ? void 0 : t.link) && void 0 !== n ? n : null === (r = e.notification) || void 0 === r ? void 0 : r.click_action;
                            ...
                            case 2:
                                return i = e.sent(), [4, (t = 3e3, new Promise(function(e) {
                                    setTimeout(e, t)
                                }))];
                            case 3:
                                return e.sent(), [3, 6];
